...
import { MdEmail, MdLock, MdVisibility, MdVisibilityOff, MdCloud } from 'react-icons/md'
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5" id="login-form">
      ...
      <p className="text-center text-sm" style={{ color: 'var(--text-muted)' }}>
        ...
        <Link to="/signup" className="font-semibold hover:underline" style={{ color: 'var(--accent-indigo)' }}>
          Create account
        </Link>
      </p>
    </form>
